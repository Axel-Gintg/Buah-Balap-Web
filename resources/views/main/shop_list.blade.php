                        ...
                        <div class="row mt-n5">
                            ...
                            <div class="col-lg-6">
                                <div class="card ml-4 mt-3 px-2 py-2 pb-0 border-left-primary" style="max-width: 520px; max-height: 200px !important;" id="">
                                    ...
                                    <div class="col-sm-4">
                                        <img src="/dist/img/logoweb.png" alt="Logo Buah Balap" style="max-width:100%;height:auto;border-radius:16px;object-fit:contain;display:block;margin:16px auto 12px auto;background:#fff;">
                                    </div>
                                    <div class="col-sm-8">
                                        <div class="card-body">
