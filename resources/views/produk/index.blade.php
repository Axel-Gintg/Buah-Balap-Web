...
<div class="d-sm-flex align-items-center justify-content-between mb-3">
  <h1 class="h3 mb-0 text-gray-800">Master Data Buah buahan</h1>
  <a href="/produk/create" class="btn btn-style float-right"><i class="fas fa-fw fa-plus"></i> Tambah Data Buah</a>
</div>
