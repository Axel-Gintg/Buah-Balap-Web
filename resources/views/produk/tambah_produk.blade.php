    ...
    <div class="row mb-5">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label for="nama_produk" class="text-dark">Nama Buah</label>
                    ...
                    <div class="form-group">
                        <label for="desc_produk" class="tex">Deskripsi Buah</label>
                        @error('desc_produk')
                            <div class=" invalid-feedback">{{ $message }}</div>
                        @enderror
                        <input id="desc_produk" type="hidden" name="desc_produk" value="{{ old('desc_produk') }}">
        ...
        <div class="col-lg-4">
            ...
            <div class="card mt-3">
                <div class="card-body">
                    <div class="mb-3">
                        <label for="harga_produk" class="text-dark">Harga Buah</label>
                    ...
                    <div class="mb-3">
                        <div class="form-group">
                            <label for="foto_produk" class="text-dark mt-3">Foto Buah</label>
                            <input type="file" class="input-file" id="foto_produk" name="foto_produk" onchange="previewImage()" >
                            <h6 class="text-center font-weight-bolder mt-3">Preview Foto Buah</h6>
                            <hr>
                            <img src="" class="tengah img-preview img-fluid mb-3 tengah" style="max-width: 280px; max-height: 280px;">
                        </div>
                    </div>
                </div>
            </div>
            <button class="btn btn-style btn-block py-2 float-right mb-3 mt-3" type="submit">Simpan Data</button>
        </div>
    </div>
</form>
