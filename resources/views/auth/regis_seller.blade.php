                                    ...
                                    <div class="accordion mt-4" id="faqExample">
                                        <div class="card">
                                            ...
                                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#faqExample">
                                                <div class="card-body">
                                                    <b>Answer:</b> Buah Balap adalah toko online yang dapat digunakan untuk memesan kebutuhan buah buahan melalui aplikasi berbasis website
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card mt-3">
                                            ...
                                            <div class="card-header p-2 st-color" id="headingThree">
                                                <h5 class="mb-0">
                                                    <button class="btn btn-link text-light collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                                        Q. Bagaimana buah buahan kami dapat diterima?
                                                    </button>
                                                    </h5>
                                            </div>
                                        ...
                                        <div class="card mt-3">
                                            ...
                                            <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#faqExample">
                                                <div class="card-body">
                                                    <b>Answer:</b>  Buah Balap dapat menerima pesana 24 jam, namun akan dikonfirmasi oleh admin dan penjual dari pukul 07.00 AM - 17.00 PM
                                                </div>
                                            </div>
                                        </div>
                                    </div>
