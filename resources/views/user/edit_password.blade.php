                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="card px-3 py-3" style="background-color: #0B3005">
                            <div class="card-body">
                                <img src="/dist/img/logoweb.png" alt="Logo" width="70%" class="tengah mb-4">
                                ...
                                <div class="accordion mt-4" id="faqExample">
                                    <div class="card">
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#faqExample">
                                            <div class="card-body">
                                                <b>Answer:</b> MaiBuah adalah toko online yang dapat digunakan untuk memesan buah melalui aplikasi berbasis website
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card mt-3">
                                        <div class="card-header p-2 st-color" id="headingTwo">
                                            ...
                                            <button class="btn btn-link text-light collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                Q: Bagaimana Cara memesan buah di Mai buah?
                                            </button>
                                            </h5>
                                        </div>
                                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#faqExample">
                                            ...
                                            <b>Answer:</b> <br>
                                              ...
                                              3. Customer dapat menunggu sampai buah diterima <br>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card mt-3">
                                        <div class="card-header p-2 st-color" id="headingThree">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link text-light collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                                    Q. Bagaimana buah kami dapat diterima?
                                                </button>
                                                </h5>
                                        </div>
                                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#faqExample">
                                            <div class="card-body">
                                            <b>Answer:</b> Mai Buah menyediakan jasa pengiriman sesuai dengan harga dari masing-masing penjual buah yang sudah ditentukan sesuai lokasi customer
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card mt-3">
                                        <div class="card-header p-2 st-color" id="headingFour">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link text-light collapsed" type="button" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                                    Q. Jam Buka Pesanan MaiBuah?
                                                </button>
                                                </h5>
                                        </div>
                                        <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#faqExample">
                                            <div class="card-body">
                                                <b>Answer:</b>  Mai Buah dapat menerima pesana 24 jam, namun akan dikonfirmasi oleh admin dan penjual dari pukul 10.00 AM - 09.00 PM
                                            </div>
                                        </div>
                                    </div>
                                </div>
